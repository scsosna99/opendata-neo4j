...
/**
 * Neo4j relationship for primary roads/routes.
 */
@RelationshipEntity(type = "PRIMARY")
public class PrimaryRoute extends BaseRoute {
     ...
     */
    public PrimaryRoute(final long routeId,
