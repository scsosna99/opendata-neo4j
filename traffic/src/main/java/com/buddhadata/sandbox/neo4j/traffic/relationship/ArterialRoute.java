...
/**
 * Neo4j relationship for arterial roads/routes.
 */
@RelationshipEntity(type = "Arterial")
public class ArterialRoute extends BaseRoute {

    /**
     * No-args constructor
     */
    public ArterialRoute() {
        super();
    }
     ...
     */
    public ArterialRoute(final long routeId,
