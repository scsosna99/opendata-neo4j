 ...
 */
@RelationshipEntity(type = "HAMMERSMITH-CITY")
public class HammersmithCity extends RouteSegmentBase {

    /**
     * Constructor
     */
    public HammersmithCity() {
    }
     ...
     */
    public HammersmithCity(StopNode start,
                           StopNode end,
                           Direction direction,
                           Double distance) {
